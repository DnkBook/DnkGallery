...
# 1) In solution explorer, right-click the DnkGallery.Presentation project and select "Open in Terminal"
...
Invoke-Expression "dotnet new mcs-uno-view $OutputParameter -n $Name --namespace DnkGallery.Presentation$SubNamespace --presentation $Presentation"
